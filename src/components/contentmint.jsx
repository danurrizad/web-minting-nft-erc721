...
const Contentmint = ({isConnected}) => {
  ...
  return (
    <div class="font-mono">
      <div class="my-6">
        <div class=" bg-blue-100 mx-12 rounded-xl shadow-xl">
            ...
            <div class="justify-center flex">
                {isConnected == false && <h2 class="text-black py-2 text-xl font-bold">You have to connect your wallet to mint</h2>}
                {isConnected == true && <button id="mint" class="border-2 border-black p-2 bg-green-400 hover:bg-green-600 my-4" onClick={Minting}>Mint this NFT</button>}
            </div>
        </div>
      </div>
    </div>
